...
['doFind', 'doInsert', 'doUpdate', 'doDelete', 'doSearch'].forEach(function(method) {
...
Mapper.prototype.search = function(expression, options) {
    options = _.defaults(options || {}, {
        return_stream: false
    });

    return Promise.try(this.doSearch, [expression, options], this).then(function(records) {
        return _.map(records, this.pack.bind(this));
    }.bind(this));
};
