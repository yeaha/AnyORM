...
class Datetime extends Default {
    ...
    getDefaultValue(attribute) {
        ...
        let default_value = attribute.default;
...
function get(type) {
    let name = get_type_name(type);
    return types[name] || types['default'];
};

function register(type_name, type_class) {
    types[type_name.toLowerCase()] = new type_class;
    return this;
};

function normalizeAttribute(attribute) {
    let type = get_type_name(attribute);
...
function get_type_name(alias) {
    ...
    const type = Object.prototype.toString.call(alias);
