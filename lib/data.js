...
// 定义一个新的Data类
exports.define = function define(options, base) {
    options = options || {};
    base = base || Data;
    ...
    Model.find = function(id, callback) {
        return mapper.find(id, callback);
    };
...
exports.Data = function Data(data) {
    ...
    data && _.each(data, function(value, key) {
        this.set(key, value);
    }.bind(this));
...
Data.prototype.refresh = function(callback) {
    if (this.isFresh()) {
        callback && callback(null, this);
        return Q(true);
    }

    return this.getMapper().refresh(this, callback);
};

Data.prototype.save = function(callback) {
    return this.getMapper().save(this, callback);
};

Data.prototype.destroy = function(callback) {
    return this.getMapper().destroy(this, callback);
};
