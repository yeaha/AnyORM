...
Mapper.prototype.save = function(data) {
    ...
    if (this.isReadonly()) {
        defered.reject(new Error('Mapper is readonly'));
        return promise;
    }
...
Mapper.prototype.destroy = function(data) {
    ...
    Q.try(_.bind(this.doDelete, this, data))
        .then(function() {
...
Mapper.prototype._insert = function(data) {
    ...
    Q.try(_.bind(this.doInsert, this, data))
        .then(function(id) {
            this.pack(id, data);
...
Mapper.prototype._update = function(data) {
    ...
    Q.try(_.bind(this.doUpdate, this, data))
        .then(function() {
            this.pack({}, data);
