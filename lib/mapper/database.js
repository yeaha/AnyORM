...
exports.CacheDBMapper = define({
    ...
    refresh: function(data) {
        return Promise.try(this._deleteCache, data.getId(), this)
                      .then(DBMapper.prototype.refresh.bind(this, data));
    },
    doFind: function(id) {
        return Promise.try(this._getCache, id, this).then(function(record) {
            ...
            return this._doFind(id).then(function(record) {
                if (record) {
    ...
    doUpdate: function(data) {
        return this._doUpdate.apply(this, arguments).then(function(result) {
    ...
    doDelete: function(data) {
        return this._doDelete.apply(this, arguments).then(function(result) {
            this._deleteCache(data.getId());
