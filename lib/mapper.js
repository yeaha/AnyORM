 ...
 * @param {Data} [data]
 * @param {object} [options]
 * @param {bool} [options.reset=false]
 * @return {Data}
 */
Mapper.prototype.pack = function(record, data, options) {
    options = options || {};
    ...
    _.each(record, function(value, key) {
        ...
        data._values[key] = value;
        delete data._dirty[key];
    }, this);
...
Mapper.prototype._insert = function(data) {
    ...
    return Promise.try(this.doInsert, data, this).then(function(primary_values) {
        ...
        this.pack(values, data, {reset: true});
