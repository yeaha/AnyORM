...
var CacheDBMapper = define({
    ...
    doFind: function(id) {
        var doFind = _.bind(DBMapper.prototype.doFind, this, arguments);
    ...
    doUpdate: function(data) {
        var doUpdate = _.bind(DBMapper.prototype.doUpdate, this, arguments);
    ...
    doDelete: function(data) {
        var doDelete = _.bind(DBMapper.prototype.doDelete, this, arguments);
