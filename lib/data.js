...
var Data = exports.Data = function(values) {
    ...
    _.each(attributes, function(config, name) {
        Object.defineProperty(_this, name, {
            get: _this._get.bind(_this, name),
            set: function(value) {
                _this._set(name, value, true);
            }
        });
    });
    ...
    _.each(attributes, function(config, name) {
        ...
        var default_value = Type.get(config.type).getDefaultValue(config);
...
Data.prototype._get = function(name, clone) {
    if (!this.has(name)) {
