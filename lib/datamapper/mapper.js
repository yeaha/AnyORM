...
function define(factory) {
    ...
    _.each(factory, function(fn, method) {
        NewMapper.prototype[method] = fn;
    });
...
Mapper.prototype.find = function(id) {
    ...
    return Q.fcall(_.bind(this.doFind, this), id)
            .then(function(data) {
                return data
...
Mapper.prototype.save = function(data) {
    ...
    return is_fresh ? this.insert(data) : this.update(data);
};

Mapper.prototype.insert = function(data) {
    return this.doInsert(data);
};

Mapper.prototype.update = function(data) {
