...
var Select = module.exports = exports = function(adapter, table) {
...
Select.prototype.order = function(column, direction) {
    if (column instanceof Expr) {
        this._order = column.toString();
    } else {
        column = this.adapter.identifier(column);
